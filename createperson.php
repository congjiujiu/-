        ...
        <div id="sidebar" class="sidebar">
            <div class="sidebar-menu nav-collapse">
                ...
                <ul>
                    ...
                    <li class="active"><a class="" href="createperson.php"><i class="fa fa-th-large fa-fw"></i> <span class="menu-text">建立新户口</span></a></li>
                </ul>
                <!-- /SIDEBAR MENU -->
            </div>
        </div>
								...
								<div class="row">
									<div class="col-md-6 col-md-offset-3">
										<div class="box border green">
											<div class="box-title">
												<h4><i class="fa fa-bars"></i>填写信息</h4>
											...
											<div class="box-body big">
												<form class="form-horizontal" role="form" method="post" action="create.php">
												  ...
												  <div class="form-group">
													...
													<div class="col-sm-9">
														<input class="form-control tip-focus" title="如: 1998/01/23" id="idcard" name="birth" type="text">
													</div>
												  </div>
												  <div class="form-group">
													<label class="col-sm-3 control-label">性别</label>
													<div class="col-sm-9">
														<input type="text" name="sex" title="男或女" class="form-control tip-focus" value="">
													</div>
												  </div>
												  <div class="form-group">
													<label class="col-sm-3 control-label">籍贯</label>
													<div class="col-sm-9">
														<input type="text" name="hometown" title="Tooltip on hover" class="form-control tip" value="">
													</div>
												  </div>
												  <div class="form-group has-success">
													<label class="col-sm-3 control-label">家庭住址</label>
													<div class="col-sm-9">
														<input type="text" class="form-control" id="inputSuccess" name="address" value="">
													</div>
												  </div>
												  <div class="form-group has-warning">
													<label class="col-sm-3 control-label">户主身份证号</label>
													<div class="col-sm-9">
														<input type="text" class="form-control" id="inputWarning" name="homeId" value="">														
													</div>
												  </div>
