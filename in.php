...
<body>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-md-offset-3">
                                        ...
                                        <div class="box border primary">
                                            <div class="box-title">
                                                <h4><i class="fa fa-bars"></i>户籍迁入</h4>
                                            ...
                                            <div class="box-body big">
                                                <form role="form" action="outTo.php" method="post">
                                                  <div class="form-group">
                                                    <label for="outId">转入者身份证号</label>
                                                    <input type="text" class="form-control" id="outId" name="outId" placeholder="18位身份证号"/>
                                                  </div>
                                                  <div class="form-group">
                                                    <label for="outHolder">转入户的户主身份证号</label>
                                                    <input type="text" class="form-control" id="outHolder" name="outHolder" placeholder="18位身份证号">
                                                  </div>
    ...
    <script>
        $('#outId').blur(function() {
            var cont = document.getElementById("outId").value;
            if(cont != '') {
                $.get("checkOutInfo.php",{idO:cont},function(data,status) {
                    alert("请确认:\n"+data);
                    document.getElementById("outHolder").focus();
                })
            }
        });
        $('#outHolder').blur(function() {
            var cont = document.getElementById("outHolder").value;
            if(cont != '') {
                $.get("checkOutInfo.php", {idI:cont}, function(data,success) {
                    alert(data);
                    document.getElementById("submitOutInfo").focus();
                })
            }
        });
    </script>
