...
<body>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-md-offset-3">
                                        ...
                                        <div class="box border primary">
                                            <div class="box-title">
                                                <h4><i class="fa fa-bars"></i>户籍注销</h4>
                                            ...
                                            <div class="box-body big">
                                                <form role="form" action="dieDelete.php" method="post">
                                                  <div class="form-group">
                                                    <label for="dieId">被注销者身份证号</label>
                                                    <input type="text" class="form-control" id="dieId" name="dieId" placeholder="18位身份证号"/>
                                                  </div>
    ...
    <script>
        $('#dieId').blur(function() {
            var cont = document.getElementById("dieId").value;
            if(cont != '') {
                $.get("dieDown.php",{dieId:cont},function(data,status) {
                    alert("\n"+data);
                    /*
                    var person = <?php echo $_SESSION['diePerson'];?>;
