                ...
                <ul>
                    ...
                    <li class="has-sub">
                        ...
                        <ul class="sub">
                            ...
                            <li><a class="" href="notifications.html"><span class="sub-menu-text">户籍迁入</span></a></li>
                            <li><a class="" href="buttons_icons.html"><span class="sub-menu-text">户籍迁出</span></a></li>
                            <li><a class="" href="sliders_progress.html"><span class="sub-menu-text">户籍注销</span></a></li>
                        </ul>
                    </li>
                                    ...
                                    <div class="box-body">
                                        <table id="datatable1" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover">
                                            ...
                                            <?php
                                                ...
                                                $stmt = $pdo->query('select * from resident natural join relation natural join family');
                                                ...
                                                while ($row) {
                                                    ...
                                                    echo '<td class="center">'.$row['relation'].'</td>';
                                                    echo '</tr>';
                                                    echo '</tbody>';
                                                    $row = $stmt->fetch(PDO::FETCH_ASSOC);
                                                }
