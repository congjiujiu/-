								...
								<div class="row">
									<div class="col-md-6 col-md-offset-3">
										<div class="box border green">
											<div class="box-title">
												<h4><i class="fa fa-bars"></i>居民信息</h4>
											...
											<div class="box-body big">
												<form class="form-horizontal" role="form" method="post" action="changeM.php">
												  ...
												  <div class="form-group">
													...
													<div class="col-sm-9">
														<input class="form-control" id="idcard" name="idcard" type="text" placeholder="<?echo $row['identityId']?>" disabled>
													</div>
												  </div>
												  <input type="hidden" name="idc" value="<?php echo $row['identityId']?>" />
												  <div class="form-group">
													<label class="col-sm-3 control-label">性别</label>
													<div class="col-sm-9">
														<input type="text" name="sex" title="Tooltip on focus" class="form-control tip-focus" value="<?php if($row['sex']==1){echo "男";}else{echo "女";}?>">
													</div>
												  </div>
												  <div class="form-group">
													<label class="col-sm-3 control-label">籍贯</label>
													<div class="col-sm-9">
														<input type="text" name="hometown" title="Tooltip on hover" class="form-control tip" value="<?php echo $row['hometown']?>">
													</div>
												  </div>
												  <div class="form-group has-success">
													<label class="col-sm-3 control-label">家庭住址</label>
													<div class="col-sm-9">
														<input type="text" class="form-control" id="inputSuccess" name="address" value="<?php echo $row['address']?>" disabled>
													</div>
												  </div>
												  <div class="form-group has-warning">
													<label class="col-sm-3 control-label">是否结婚</label>
													<div class="col-sm-9">
														<input type="text" class="form-control" id="inputWarning" name="marriage" value="<?php if($row['marraige']==0){echo "否";}else{echo "是";}?>">														
													</div>
												  </div>
												  <button type="submit" class="col-md-offset-5 btn btn-primary">提交</button>
												 </form>
											</div>
										</div>
									</div>
