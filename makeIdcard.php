        ...
        <div id="sidebar" class="sidebar">
            <div class="sidebar-menu nav-collapse">
                ...
                <ul>
                    ...
                    <li class="active"><a class="" href="makeIdcard.php"><i class="fa fa-envelope-o fa-fw"></i> <span class="menu-text">办理身份证</span></a></li>
                                    ...
                                    <div class="box-body">
                                        <table id="datatable1" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover">
                                            ...
                                            <?php
                                                ...
                                                $stmt = $pdo->query("select identityId,name,sex,address,hometown,relationId, card from users natural join resident natural join family where email='$n'");
                                                ...
                                                while ($row) {
                                                    ...
                                                    if($row['card']==0) {
                                                        echo '<td><a href="makeCard.php?id='.$row['identityId'].'">现在办理</a></td>';
                                                    }
                                                    else if($row['card']==1) {
                                                        echo '<td>正在办理</td>';
                                                    }
